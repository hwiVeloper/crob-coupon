  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="쿠오븐 쿠폰 대량 입력 페이지입니다." />
        <meta
          name="keywords"
        ...
        <meta property="og:description" content="쿠오븐 쿠폰 대량 입력 페이지입니다." />
        {/* <meta property="og:image" content="" /> */}

        {/* Global site tag (gtag.js) - Google Analytics */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-99293532-4"></script>
        <script>
